...
class _SignupWidgetState extends State<SignupWidget> {
  ...
  void initState() {
    ...
    _model.plantTextController ??= TextEditingController();
    _model.plantFocusNode ??= FocusNode();
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: Container(
                                width: 200.0,
                                child: TextFormField(
                                  controller: _model.plantTextController,
                                  focusNode: _model.plantFocusNode,
                                  autofocus: false,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    isDense: true,
                                  ...
                                  cursorColor:
                                      FlutterFlowTheme.of(context).primaryText,
                                  enableInteractiveSelection: true,
                                  validator: _model.plantTextControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                            ),
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.createpasswordTextController,
                    ...
                    onPressed: () async {
                      ...
                      await UserRecord.collection.doc(user.uid).update({
                        ...createUserRecordData(
                          ...
                          plantGrown: _model.plantTextController.text,
                          phoneNumber: _model.contactnumberTextController.text,
