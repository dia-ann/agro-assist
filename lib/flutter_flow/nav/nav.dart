...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: Weather1Widget.routeName,
          path: Weather1Widget.routePath,
          builder: (context, params) => Weather1Widget(
            temp: params.getParam(
              'temp',
              ParamType.double,
            ),
        ...
        FFRoute(
          name: CropsuggestionsWidget.routeName,
          path: CropsuggestionsWidget.routePath,
          builder: (context, params) => CropsuggestionsWidget(
            lat: params.getParam(
              'lat',
              ParamType.double,
            ),
            ...
            humidity: params.getParam(
              'humidity',
              ParamType.double,
            ),
            rainfall: params.getParam(
              'rainfall',
              ParamType.double,
            ),
          ),
        ...
        FFRoute(
          name: OrganicfarmingWidget.routeName,
          path: OrganicfarmingWidget.routePath,
          builder: (context, params) => OrganicfarmingWidget(),
        ),
        FFRoute(
